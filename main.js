;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)', 'p', 'JANGAN LUPA', 'P', 'PAKAI LANSCAPE MODE', 'p', '.......', 'p', 'YANG', 'P', 'MAAFIN AING YA', 'P', 'TIAP HARI', 'p', 'BIKIN MANEH KESEL MULU', "p", 'BIKIN GAMOOD TERUS', 'p', 'MANEH SI', 'p', 'NGESELIN', 'p', 'TAPI', 'p', 'AING TETEP SAYANG', 'p', 'HEHE', 'p', 'UDAHLAH', 'p', 'GITU AJA', 'p', 'AING GATAU', 'p', 'MAU BILANG APALAGI', 'P', 'LOVE YOU SAYANGKUUU']
